...
Shader "Tesselation"
{
	Properties
	{
		...
		_Float1("Float 1", Range( 0.3 , 3)) = 0.3
		_Float2("Float 2", Float) = 0.08
		[ASEEnd]_Float4("Float 4", Float) = -0.63
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 panner40 = ( ( 1.43 * _TimeParameters.x ) * float2( 1,0 ) + texCoord39);
				float2 panner41 = ( ( _TimeParameters.x * _Float4 ) * float2( 0,1 ) + texCoord39);
				float4 appendResult44 = (float4((panner40).x , (panner41).y , 0.0 , 0.0));
				float4 tex2DNode17 = tex2Dlod( _TextureSample1, float4( appendResult44.xy, 0, 0.0) );
				...
				#endif
				float3 vertexValue = ( ( tex2DNode17 * float4( inputMesh.positionOS , 0.0 ) ) * _Float2 ).rgb;
						...
						)
			{
				...
				float4 color13 = IsGammaSpace() ? float4(1,0.3615363,0,0) : float4(1,0.1074883,0,0);
				float2 texCoord39 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner40 = ( ( 1.43 * _TimeParameters.x ) * float2( 1,0 ) + texCoord39);
				float2 panner41 = ( ( _TimeParameters.x * _Float4 ) * float2( 0,1 ) + texCoord39);
				float4 appendResult44 = (float4((panner40).x , (panner41).y , 0.0 , 0.0));
				float4 tex2DNode17 = tex2D( _TextureSample1, appendResult44.xy );
				float4 break25 = tex2DNode17;
				float4 appendResult26 = (float4(break25.r , break25.g , 0.0 , 0.0));
				float3 hdEmission11 = ASEGetEmissionHDRColor(( color13 * appendResult26 ).rgb,5.0,5.0,GetInverseCurrentExposureMultiplier());
				...
				surfaceDescription.Emission = hdEmission11;
				surfaceDescription.Smoothness = 0.5;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = pow( tex2DNode17 , temp_cast_3 ).r;
		...
		Pass
		{
					...
					)
			{
				...
				surfaceDescription.Alpha = pow( tex2DNode17 , temp_cast_1 ).r;
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-562,146.5;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;13;-876.6996,-294.5;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;1,0.3615363,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-645.5416,-47.01606;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.HDEmissionNode;11;-297.9005,-130.7;Inherit;False;Luminance;False;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;17;-1466.979,-71.28449;Inherit;True;Property;_TextureSample1;Texture Sample 1;0;0;Create;True;0;0;0;False;0;False;-1;d7635b6d550cbc3459812cd790010baf;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PosVertexDataNode;30;-659.4819,361.1874;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-389.082,373.9874;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.PowerNode;27;-1190.917,204.011;Inherit;True;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-1615.718,180.9108;Inherit;False;Property;_Float1;Float 1;1;0;Create;True;0;0;0;False;0;False;0.3;0;0.3;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;26;-928.8187,-103.1875;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.BreakToComponentsNode;25;-1157.618,-154.6873;Inherit;True;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;71.71808,367.5872;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-193.8819,463.5874;Inherit;False;Property;_Float2;Float 2;2;0;Create;True;0;0;0;False;0;False;0.08;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;366.4,-65.6;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;12;Tesselation;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;33;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefGBuffer;255;False;;255;True;_StencilWriteMaskGBuffer;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;True;0;True;_ZTestGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;39;Surface Type;1;638144681673435899;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;0;0;  Energy Conserving Specular;1;0;  Transmission,InvertActionOnDeselection;0;0;Forward Only;0;0;Receive Decals;1;0;Receives SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;DOTS Instancing;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;1;638144686866459511;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;11;True;True;True;True;True;True;False;False;False;True;True;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;35;-2601.845,-350.4787;Inherit;False;Constant;_Float3;Float 3;3;0;Create;True;0;0;0;False;0;False;1.43;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-2321.845,-408.0782;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;34;-2603.445,-276.8787;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;40;-1982.645,-568.077;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;39;-2211.445,-321.6786;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;41;-1960.244,-312.0783;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,1;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;36;-2622.646,-153.679;Inherit;False;Property;_Float4;Float 4;3;0;Create;True;0;0;0;False;0;False;-0.63;-0.63;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;-2355.448,-153.679;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;42;-1712.655,-516.3943;Inherit;False;True;False;True;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;43;-1729.285,-304.3643;Inherit;False;False;True;True;True;1;0;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;44;-1508.94,-408.3011;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=1DD0A513F509419E8D8CE0E8A11E2702A05F5F3B